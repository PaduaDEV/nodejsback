    ...
    public static async abrirConexao()
    {
        try
        {
            if(this.conexao === null || this.conexao.isClosed())
            {
                ...
                this.conexao = await oracle.getConnection({user: 'C##NODE', password: 'node', connectString: 'localhost:1521/XE'});
        ...
        {
            throw new ConexaoError("Não foi possível abrir conexão com o banco de dados", 404, error);
        }
    }
